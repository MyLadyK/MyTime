...
public class Turno {
	 ...
	 * @param diaInicio  Atributo que indica el dia de la semana de inicio de
	 *                   <strong>Turno</strong>
	 * @param diaFin     Atributo que indica el dia de la semana que acaba el
	 *                   <strong>Turno</strong>
	 * @param horaInicio Atributo que indica la hora a la que comienza el
	 *                   <strong>Turno</strong>
	 * @param horaFin    Atributo que indica la hora a la que finaliza el
	 *                   <strong>Turno</strong>
	 * @param tipoTurno  Atributo que indica el tipo de <strong>Turno</strong>
	 */
	public Turno(int idTurno, int anno, String mes, String diaInicio, String diaFin, String horaInicio, String horaFin,
			String tipoTurno, int idUsuario) {
		super();
	...
	/**
	 * Constructor con todos los atributos salvo idTurno para insertar en la
	 ...
	 * @param tipoTurno  Atributo que indica el tipo de <strong>Turno</strong>
	 */
	public Turno(int anno, String mes, String diaInicio, String diaFin, String horaInicio, String horaFin,
			String tipoTurno, int idUsuario) {
		super();
		this.anno = anno;
		this.mes = mes;
	 ...
	 * @param tipoTurno Atributo que indica el tipo de <strong>Turno</strong>
	 */
	public Turno(int anno, String mes, String tipoTurno, int idUsuario) {
		super();
		this.anno = anno;
		this.mes = mes;
		this.tipoTurno = tipoTurno;
	 ...
	 * @param tipoTurno Atributo que indica el tipo de <strong>Turno</strong>
	 */
	public Turno(int idTurno, int anno, String mes, String tipoTurno, int idUsuario) {
		super();
		this.idTurno = idTurno;
		this.anno = anno;
		this.mes = mes;
	...
	/**
	 * Metodo insertarTurno, el cual <strong>añade</strong> los datos del turno
	 * generado a la base de datos mediante un formulario
	 * 
	...
	/**
	 * Metodo listar, el cual <strong>lista</strong> los turnos previamente
	 * insertados en la base de datos
	 * 
	 * @return Devuelve la <strong>lista de turnos</strong> obtenida de la base de
	 *         datos
